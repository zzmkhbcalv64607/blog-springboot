package com.liella.aspect;

import cn.dev33.satoken.stp.StpUtil;
import com.alibaba.fastjson2.JSON;
import com.liella.annotation.OptLogger;
import com.liella.entity.OperationLog;
import com.liella.manager.AsyncManager;
import com.liella.manager.factory.AsyncFactory;
...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.liella.annotation.OptLogger)")
    ...
    public void doAfterReturning(JoinPoint joinPoint, Object result) {
        ...
        // 请求用户昵称
        operationLog.setNickname(userService.getById(StpUtil.getLoginIdAsInt()).getNickname());
        // 操作ip和操作地址
