...
import com.liella.service.CommentService;
...
import static com.liella.constant.RedisConstant.COMMENT_LIKE_COUNT;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    private void sendEmail(Comment comment, User toUser, String title, String fromNickname) {
        ...
        if (comment.getIsCheck().equals(TRUE)) {
            ...
            // 将mailDTO和 EMAIL_HTML_KEY 交给 EMAIL_EXCHANGE 队列 通过队列  发送HTML邮件
